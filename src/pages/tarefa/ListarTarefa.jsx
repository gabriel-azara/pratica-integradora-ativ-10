              ...
              <TableBody>
                {tarefas.map((row, indice) => (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Button variant="contained" color="error" onClick={() => handleOpenConfirm(row.idTarefa)}><DeleteIcon fontSize="small" /></Button>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
      ...
      <div>
        ...
        >
          <Box sx={style}>
            ...
            <Button variant="contained" color="error" onClick={handleDeletar}>Excluir</Button>
            <Button variant="contained" color="primary" onClick={handleCloseConfirm} sx={{ ml: 2 }}>Cancelar</Button>
          </Box>
        </Modal>
      </div>
    </>
